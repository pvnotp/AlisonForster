...
export class ProjectsComponent {
  public readonly alchemy: BlockData[] = [
    ...
    { text: 'ALCHEMY', width: 0.6, linkText: 'VISIT', link: 'https://alchemycoaching-gacve7fsgmarengw.eastus2-01.azurewebsites.net/' },
  ];
  ...
  public readonly geocities: BlockData[] = [
    ...
    { text: 'GEOCITIES', width: 0.9, linkText: 'VISIT', link: 'https://geocitiestimes-h2daaffnehapbhav.eastus2-01.azurewebsites.net/' },
    { text: 'THE', width: 0.3 },
  ];
}
